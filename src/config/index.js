...
let CONFIG = {
  url: document.URL.indexOf('catchme') !== -1 ?  'http://front.catchme.cn/' : 'http://front.5zhua.cn/',
  // url: document.URL.indexOf('catchme') !== -1 ?  'http://front.catchme.com.cn/' : 'http://front.5zhua.cn/',
  localtionUrl: document.URL.indexOf('catchme') !== -1 ? 'http://www.catchme.cn/':'http://www.5zhua.cn/',
