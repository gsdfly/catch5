<template>
  <div class="guide" :class="{'guide-version2':version2}">
    ...
    <div class="bg2"></div>
    <img v-if="activity_bounty[activity_bounty.length-1].voucher_batch.category === 0 && (!((gzh_operation.coupon && gzh_operation.coupon.status !=2) || (gzh_operation_other.task_count < gzh_operation_other.num)) || guideNum == 2)" class="guideImg2" src="./../assets/guoqing/wawa.png" alt="">
    <img v-if="activity_bounty[activity_bounty.length-1].voucher_batch.category === 1 && (!((gzh_operation.coupon && gzh_operation.coupon.status !=2) || (gzh_operation_other.task_count < gzh_operation_other.num)) || guideNum == 2)" class="guideImg2" src="./../assets/guoqing/guideImg2.png" alt=""/>
    <div class="bg3"></div>
...
<script>
  ...
  export default {
    ...
    data(){
      return {
        img1:require('./../assets/guoqing/bg1-2.png'),
        img2:require('./../assets/guoqing/bg1-1.png'),
        guideNum:1
      }
    },
    mounted(){
